...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex text-slate-900 font-sans relative overflow-hidden">
      {/* Mobile Backdrop */}
      <AnimatePresence>
        {isSidebarOpen && (
          <motion.div
      ...
      `}>
        <div className="h-20 flex items-center gap-3 px-6 border-b border-slate-100 overflow-hidden">
          ...
          <AnimatePresence mode="wait">
            {isSidebarOpen && (
              <motion.span 
                ...
                className="font-display font-bold text-lg text-slate-900 tracking-tight whitespace-nowrap"
              >
                Gyan Teaching Fellowship
              </motion.span>
            )}
          </AnimatePresence>
        </div>
